...
Currently 1.0.0-alpha.5 is tentatively released.

https://github.com/ikwzm/uiomem/tree/v1.0.0-alpha.5.
...
[  562.657246] uiomem uiomem0: driver version = 1.0.0-alpha.5
...
[  773.889476] uiomem uiomem0: driver version = 1.0.0-alpha.5
